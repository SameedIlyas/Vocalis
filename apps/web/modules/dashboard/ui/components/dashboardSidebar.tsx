                            ...
                            {customerSupportItems.map((item) => {
                                ...
                                <SidebarMenuItem key={item.title}>
                                    <SidebarMenuButton
                                       ...
                                       className={cn(
                                        isActive(item.url) && "bg-gradient-to-b from-sidebar-primary to-[#fbbf24]! text-sidebar-primary-foreground! hover:to-[#fbbf24]/90!"
                                       )}
                                       tooltip={item.title}
                                    >
                                        <Link href={item.url}>
                    ...
                    <SidebarMenuItem>
                        <UserButton 
                            ...
                            appearance={{
                                elements: {
                                    rootBox: "w-full! h-8!",
                                    userButtonTrigger: "w-full! p-2! hover:bg-sidebar-accent! hover:text-sidebar-accent-forgeround! group-data-[collapsible=icon]::size-8! group-data-[collapsible=icon]:p-2!",
