...
export const AIMessageContent = ({
  ...
  <div
    className={cn(
      ...
      "group-[.is-user]:border-transparent group-[.is-user]:bg-gradient-to-b group-[.is-user]:from-primary group-[.is-user]:to-[#fbbf24] group-[.is-user]:text-primary-foreground",
      className
    )}
    {...props}
  >
